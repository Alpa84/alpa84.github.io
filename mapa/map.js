...
// }
let initialContestants = {
            'CAMBIEMOS': { votesOrParty: "CAMBIEMOS", name: "CAMBIEMOS", nombreCandidato: "LEON DANIELA CRISTINA" },
            'FRENTE PROGRESISTA CÍVICO Y SOCIAL': { votesOrParty: "FRENTE PROGRESISTA CÍVICO Y SOCIAL", name: "FRENTE PROGRESISTA CÍVICO Y SOCIAL", nombreCandidato: "RUEDA SUSANA ESTELA" },
            'JUNTOS': { votesOrParty: "JUNTOS", name: "JUNTOS", nombreCandidato: "TONIOLLI EDUARDO LEANDRO" },
            'PARA LA CIUDAD FUTURA': { votesOrParty: "PARA LA CIUDAD FUTURA", name: "PARA LA CIUDAD FUTURA", nombreCandidato: "TEPP CAREN ESTEFANIA" },
            'UNITE POR LA FAMILIA Y LA VIDA': { votesOrParty: "UNITE POR LA FAMILIA Y LA VIDA", name: "UNITE POR LA FAMILIA Y LA VIDA", nombreCandidato: "COZZONI ARIEL OSVALDO" },
}
...
const init = () => {
    ...
    generateInternalMap({
        position: 'gobernador',
        containerId: 'gobernadorContainer',
        scaleContainerId: 'gobernadorScaleContainer',
        includeNonWinners: true,
        candidates: {
            'JUNTOS': { votesOrParty: "JUNTOS", name: "JUNTOS", nombreCandidato: "PEROTTI OMAR ANGEL" },
            'FRENTE PROGRESISTA CÍVICO Y SOCIAL': { votesOrParty: "FRENTE PROGRESISTA CÍVICO Y SOCIAL", name: "FRENTE PROGRESISTA CÍVICO Y SOCIAL", nombreCandidato: "BONFATTI ANTONIO JUAN" },
            'CAMBIEMOS': { votesOrParty: "CAMBIEMOS", name: "CAMBIEMOS", nombreCandidato: "CORRAL JOSE MANUEL" },
        },
    })
    generateInternalMap({
        position: 'concejal',
        containerId: 'concejalesContainer',
        scaleContainerId: 'concejalesScaleContainer',
        includeNonWinners: true,
        candidates: {
            'CAMBIEMOS': { votesOrParty: "CAMBIEMOS", name: "CAMBIEMOS", nombreCandidato: "LEON DANIELA CRISTINA" },
            'FRENTE PROGRESISTA CÍVICO Y SOCIAL': { votesOrParty: "FRENTE PROGRESISTA CÍVICO Y SOCIAL", name: "FRENTE PROGRESISTA CÍVICO Y SOCIAL", nombreCandidato: "RUEDA SUSANA ESTELA" },
    ...
    generateInternalMap({
        ...
        includeNonWinners: true,
        candidates: {
            'CAMBIEMOS': { votesOrParty: "CAMBIEMOS", name: "CAMBIEMOS", nombreCandidato: "LOPEZ MOLINA RODRIGO MANUEL" },
            'FRENTE PROGRESISTA CÍVICO Y SOCIAL': { votesOrParty: "FRENTE PROGRESISTA CÍVICO Y SOCIAL", name: "FRENTE PROGRESISTA CÍVICO Y SOCIAL", nombreCandidato: "JAVKIN PABLO LAUTARO" },
            'JUNTOS': { votesOrParty: "JUNTOS", name: "JUNTOS", nombreCandidato: "SUKERMAN ROBERTO" },
            'PARA LA CIUDAD FUTURA': { votesOrParty: "PARA LA CIUDAD FUTURA", name: "PARA LA CIUDAD FUTURA", nombreCandidato: "MONTEVERDE JUAN" },
        },
    })
    generateInternalMap({
        position: 'diputado',
        containerId: 'diputadosContainer',
        scaleContainerId: 'diputadosScaleContainer',
        includeNonWinners: true,
        candidates: {
            'CAMBIEMOS': { votesOrParty: "CAMBIEMOS", name: "CAMBIEMOS", nombreCandidato: "CHUMPITAZ FILIPONE GABRIEL FELIPE" },
            'FRENTE PROGRESISTA CÍVICO Y SOCIAL': { votesOrParty: "FRENTE PROGRESISTA CÍVICO Y SOCIAL", name: "FRENTE PROGRESISTA CÍVICO Y SOCIAL", nombreCandidato: "LIFSCHITZ ROBERTO MIGUEL" },
            'FRENTE SOCIAL Y POPULAR': { votesOrParty: "FRENTE SOCIAL Y POPULAR", name: "FRENTE SOCIAL Y POPULAR", nombreCandidato: "DEL FRADE CARLOS ALFREDO" },
